...
- Prediction-checkpoint reveal leak: resolved by routing observe/explain through `SimRuntime` with package-level prediction and Playwright pre-commit DOM assertions.
