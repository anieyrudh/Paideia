# ODE Phase Portrait · Technical Record
...
- Container path: `sutd/content/smt/containers/ode-phase-portrait`
- Status: `reviewed`
...
- Container validation: `pnpm container:validate sutd/content/smt/containers/ode-phase-portrait`
- Docs regeneration: `pnpm container:docs sutd/content/smt/containers/ode-phase-portrait`
...
```bash
pnpm container:docs sutd/content/smt/containers/ode-phase-portrait
pnpm container:validate sutd/content/smt/containers/ode-phase-portrait
pnpm graph:generate
```
...
- Formula substitution required for shown calculations — addressed in the observation formula trail for trace, determinant, discriminant, eigenvalues, and RK4 trajectory setup.
...
- Concrete axe evidence: `pnpm -F @paideia/sim-harness test` on 2026-05-19 ran `sutd/content/smt/containers/ode-phase-portrait/simulation/simulation.test.ts`; the revealed-state axe scan reported 0 critical or serious violations for `sutd/smt/ode-phase-portrait/ode-phase-portrait`.
...
- Built the SUTD SMT ODE phase portrait as one v2 container plus one SUTD sim export.
