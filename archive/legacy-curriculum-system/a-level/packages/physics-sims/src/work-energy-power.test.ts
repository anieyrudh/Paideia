...
import { workEnergyPowerModel } from "./work-energy-power.js";
import { runWorkEnergyPowerGateContract } from "./work-energy-power.contract.js";

describe("work-energy-power sim", () => {
  it("computes positive work, kinetic energy change, and average power through core mechanics", () => {
    const model = workEnergyPowerModel({
...
runWorkEnergyPowerGateContract();
