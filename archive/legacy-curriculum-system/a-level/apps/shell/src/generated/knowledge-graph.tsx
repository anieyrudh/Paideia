...
import GeneratedSim0ConfidenceIntervalsMeanIntervalLab from "@paideia/a-level-math-sims/confidence-intervals";
import GeneratedSim1HypothesisTestingTestStatisticDecisionLab from "@paideia/a-level-math-sims/hypothesis-testing";
import GeneratedSim2NormalDistributionNormalAreaStandardisationLab from "@paideia/a-level-math-sims/normal-distribution";
import GeneratedSim3ProbabilityStatisticsProbabilityStatisticsLab from "@paideia/a-level-math-sims/probability-statistics";
import GeneratedSim4AlternatingCurrentAcRmsPhaseLab from "@paideia/a-level-physics-sims/alternating-current";
import GeneratedSim5CapacitanceCapacitorChargeEnergyLab from "@paideia/a-level-physics-sims/capacitance";
import GeneratedSim6CircuitsSeriesParallelCircuitLab from "@paideia/a-level-physics-sims/circuits";
import GeneratedSim7CircularMotionCentripetalForceVectorLab from "@paideia/a-level-physics-sims/circular-motion";
import GeneratedSim8ElectricFieldsChargeFieldVectorLab from "@paideia/a-level-physics-sims/electric-fields";
import GeneratedSim9ForcesAndEquilibriumForceBalance from "@paideia/a-level-physics-sims/forces-and-equilibrium";
import GeneratedSim10GravitationalFieldsInverseSquareFieldLab from "@paideia/a-level-physics-sims/gravitational-fields";
import GeneratedSim11KinematicsInOneDimensionMotionEquationsLab from "@paideia/a-level-physics-sims/kinematics-one-dimension";
import GeneratedSim12MagneticFieldsMagneticForceDirectionLab from "@paideia/a-level-physics-sims/magnetic-fields";
...
export const knowledgeGraph = {
  nodes: [
  {
    id: "a-level/mathematics/confidence-intervals",
    conceptId: "confidence-intervals",
  ...
  edges: [
  { from: "a-level/mathematics/probability-statistics", to: "a-level/mathematics/confidence-intervals", kind: "prerequisite" },
  { from: "a-level/mathematics/normal-distribution", to: "a-level/mathematics/confidence-intervals", kind: "prerequisite" },
  { from: "a-level/mathematics/hypothesis-testing", to: "a-level/mathematics/confidence-intervals", kind: "prerequisite" },
  { from: "a-level/mathematics/confidence-intervals", to: "a-level/mathematics/model-criticism", kind: "downstream" },
  { from: "a-level/mathematics/confidence-intervals", to: "a-level/mathematics/sampling-distributions", kind: "downstream" },
  { from: "a-level/mathematics/confidence-intervals", to: "a-level/mathematics/hypothesis-testing", kind: "sibling" },
  { from: "a-level/mathematics/confidence-intervals", to: "a-level/mathematics/normal-distribution", kind: "sibling" },
...
export const containers = [
  {
    ...
    module: "Probability and Statistics",
    title: "Confidence Intervals",
    summary: "Estimate a population mean with known sigma, compute the margin of error, and interpret confidence without treating the parameter as random.",
    syllabusRef: "9758 / Probability and Statistics / 6.6 Confidence intervals",
    status: "reviewed",
    ...
    sims: [
      {
        ...
        harnessId: "a-level/mathematics/confidence-intervals/mean-interval-lab",
        title: "Mean Interval Lab",
        interactionType: "decision-matrix",
        component: GeneratedSim0ConfidenceIntervalsMeanIntervalLab,
      },
    ],
  },
  {
    ...
    sims: [
      {
        ...
        interactionType: "decision-matrix",
        component: GeneratedSim1HypothesisTestingTestStatisticDecisionLab,
      },
    ],
  },
  {
    ...
    sims: [
      {
        ...
        interactionType: "decision-matrix",
        component: GeneratedSim2NormalDistributionNormalAreaStandardisationLab,
      },
    ],
  },
  {
    ...
    sims: [
      {
        ...
        interactionType: "decision-matrix",
        component: GeneratedSim3ProbabilityStatisticsProbabilityStatisticsLab,
      },
    ],
  },
  {
    ...
    sims: [
      {
        ...
        component: GeneratedSim4AlternatingCurrentAcRmsPhaseLab,
      },
    ],
  },
  {
    ...
    sims: [
      {
        ...
        interactionType: "diagram-builder",
        component: GeneratedSim5CapacitanceCapacitorChargeEnergyLab,
      },
    ],
  },
  {
    ...
    sims: [
      {
        ...
        interactionType: "diagram-builder",
        component: GeneratedSim6CircuitsSeriesParallelCircuitLab,
      },
    ],
  },
  {
    ...
    sims: [
      {
        ...
        interactionType: "diagram-builder",
        component: GeneratedSim7CircularMotionCentripetalForceVectorLab,
      },
    ],
  },
  {
    ...
    sims: [
      {
        ...
        interactionType: "diagram-builder",
        component: GeneratedSim8ElectricFieldsChargeFieldVectorLab,
      },
    ],
  },
  {
    ...
    sims: [
      {
        ...
        interactionType: "diagram-builder",
        component: GeneratedSim9ForcesAndEquilibriumForceBalance,
      },
    ],
  },
  {
    ...
    sims: [
      {
        ...
        component: GeneratedSim10GravitationalFieldsInverseSquareFieldLab,
      },
    ],
  },
  {
    ...
    sims: [
      {
        ...
        component: GeneratedSim11KinematicsInOneDimensionMotionEquationsLab,
      },
    ],
  },
  {
    ...
    sims: [
      {
        ...
        interactionType: "diagram-builder",
        component: GeneratedSim12MagneticFieldsMagneticForceDirectionLab,
      },
    ],
  },
  {
    ...
    sims: [
      {
        ...
        interactionType: "diagram-builder",
        component: GeneratedSim13MomentumMomentumCollisionLab,
      },
    ],
  },
  {
    ...
    sims: [
      {
        ...
        interactionType: "animation-playback",
        component: GeneratedSim14OscillationsSimpleHarmonicMotionLab,
      },
    ],
  },
  {
    ...
    sims: [
      {
        ...
        interactionType: "decision-matrix",
        component: GeneratedSim15PhysicalQuantitiesAndUnitsMeasurementUncertaintyLab,
      },
    ],
  },
  {
