...
export type NewtonsPerMetre = Brand<number, "NewtonsPerMetre">;
...
export const metresPerSecondSquared = (n: number) => n as MetresPerSecondSquared;
...
export const newtonsPerMetre = (n: number) => n as NewtonsPerMetre;
