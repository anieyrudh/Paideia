...
- Image selection starts with a fixed normalised box in Tier 1. Consumers that
  need freehand drawing should extend the component without changing the stored
  `ImageTarget` shape.
