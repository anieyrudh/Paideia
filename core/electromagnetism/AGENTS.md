...
potential-energy helpers in SI units, plus parallel-plate dielectric capacitor
calculations. It is pure TypeScript and returns
...
- Parallel-plate capacitor geometry uses SI values: square metres, metres,
  dimensionless dielectric constant, volts, farads, coulombs, and joules.

## What this module does NOT do
- Does **not** render field lines, vector plots, charges, or apparatus.
- Does **not** model arbitrary distributed charges, fringing fields, magnetic
  fields, circuits, relativity, nonlinear dielectrics, or dielectric breakdown.
...
parallel-plate dielectric capacitor using `C = kappa epsilon0 A / d`,
`Q = CV`, and `U = 1/2 CV^2`. If a sim is about to inline these formulae, use
this module instead.
