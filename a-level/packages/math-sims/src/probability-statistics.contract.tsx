...
export const runProbabilityStatisticsGateContract = () => {
  describe("probability statistics prediction-checkpoint contract", () => {
    it("blocks distribution readouts until the prediction checkpoint is committed", async () => {
      await renderSim();
      ...
      expect(document.body.textContent).toContain("z = (5.40");
