...
import GeneratedSim0PhysicalQuantitiesAndUnitsQuantityDependencyMap from "@paideia/a-level-physics-sims/physical-quantities";
...
export const containers = [
  {
    ...
    predictPrompt: "A newton is the unit of force. Which dependency chain should prove that N reduces to kg m s^-2?",
    aidTypes: [
      "simulation",
      "reasoning-lab",
      "misconception-audit",
    ...
    misconceptions: [
      ...
      "Derived quantity as base quantity",
    ],
    ...
    sims: [
      {
        ...
        title: "Quantity Dependency Map Lab",
