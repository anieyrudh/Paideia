...
import GeneratedSim0PhysicalQuantitiesAndUnitsImpossibleEquationDetector from "@paideia/a-level-physics-sims/impossible-equation-detector";
...
export const containers = [
  {
    ...
    module: "Foundations of Physics",
    title: "Physical Quantities and Units",
    summary: "Separate a physical quantity from its numerical value and unit, then use SI dimensions to reject impossible equations.",
    syllabusRef: "9478 / Section I / 1(a)-1(g)",
    status: "reviewed",
    packageId: "physical-quantities-and-units",
    simId: "impossible-equation-detector",
    predictPrompt: "A student proposes four equations. Before opening the unit detector, which one must be impossible because its units do not match?",
    aidTypes: [
      "simulation",
      "misconception-audit",
      "transfer-problem",
    ...
    misconceptions: [
      ...
      "Scalar-vector units are enough",
    ],
    ...
    firstPrinciples: "A physical quantity is something measurable about the world. A measurement is complete only when it gives both a numerical value and a unit. Writing 5 is just a number; writing 5 m says the quantity is a length and the metre is the comparison standard.",
    keyDefinitions: [
    ...
    problemSolvingSteps: [
      ...
      "Check dimensions before adding terms",
      "Compare left and right dimensions",
      "Check scalar or vector direction requirements",
    ...
    sims: [
      {
        id: "impossible-equation-detector",
        title: "Impossible Equation Detector",
        interactionType: "decision-matrix",
        component: GeneratedSim0PhysicalQuantitiesAndUnitsImpossibleEquationDetector,
      },
    ],
  },
  {
