...
import GeneratedSim0PhysicalQuantitiesAndUnitsUnitClassificationLab from "@paideia/a-level-physics-sims/unit-classification";
...
export const containers = [
  {
    ...
    predictPrompt: "Before opening the unit lab, which kind of mistake do you think you are most likely to make when reading a measurement or equation?",
    aidTypes: [
      "simulation",
      "misconception-audit",
      "transfer-problem",
    ...
    problemSolvingSteps: [
      ...
      "Ask whether direction is part of the meaning",
