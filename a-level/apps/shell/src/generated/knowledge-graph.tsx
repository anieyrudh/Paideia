...
export const containers = [
  {
    ...
    module: "Foundations of Physics",
    title: "Physical Quantities and Units",
    summary: "Separate physical quantities from units, then use base dimensions to detect valid and impossible equations.",
    syllabusRef: "9478 / Section I / 1(a)-1(g)",
    status: "reviewed",
    packageId: "physical-quantities-and-units",
    simId: "dimensional-consistency-checker",
    predictPrompt: "Before opening the checker, which equation is impossible because the units on the two sides cannot match?",
    aidTypes: [
      "simulation",
      "misconception-audit",
      "transfer-problem",
    ...
    problemSolvingSteps: [
      ...
      "Classify base/derived and scalar/vector where relevant",
      "Expand derived units into base dimensions",
      "Combine dimensions according to the operation",
      "Check dimensions before equating or adding",
