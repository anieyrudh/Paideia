...
export const containers = [
  {
    ...
    predictPrompt: "Four equations look familiar. Before seeing the unit check, which one must be impossible because its units do not match?",
    aidTypes: [
      "simulation",
      "misconception-audit",
      "transfer-problem",
    ...
    problemSolvingSteps: [
      ...
      "Decide scalar or vector in context",
      "Expand derived units into base dimensions",
      "Check dimensions before adding or equating",
      "Convert using unit ratios",
      "State what the unit check proves",
    ],
    prerequisites: [],
    downstream: [
      "Scalars and Vectors",
