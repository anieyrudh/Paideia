...
import GeneratedSim0ForcesAndEquilibriumForcesAndEquilibrium from "core/plotting";
...
export const containers = [
  {
    ...
    module: "physics",
    title: "Forces and Equilibrium",
    summary: "<One sentence (<=300 chars) - appears on catalogue cards>",
    syllabusRef: "<SYLLABUS / SECTION>",
    status: "skeleton",
    packageId: "forces-and-equilibrium",
    simId: "forces-and-equilibrium",
    predictPrompt: "<Prediction prompt shown before the main reveal.>",
    aidTypes: [
      "simulation",
    ],
    misconceptions: [],
    transferProblem: "No transfer problem registered yet.",
    ...
    sims: [
      {
        id: "forces-and-equilibrium",
        harnessId: "a-level/physics/forces-and-equilibrium/forces-and-equilibrium",
        title: "Forces and Equilibrium Explorer",
        interactionType: "function-plot-with-draggable",
        component: GeneratedSim0ForcesAndEquilibriumForcesAndEquilibrium,
      },
    ],
  },
  {
