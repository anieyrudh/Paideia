...
export const containers = [
  {
    ...
    module: "Foundations of Physics",
    title: "Physical Quantities and Units",
    summary: "Separate physical quantities from numerical values and units, then use SI dimensions and measurement uncertainty to constrain valid equations.",
    syllabusRef: "9478 / Section I / 1(a)-1(g)",
    status: "draft",
    packageId: "physical-quantities-and-units",
    simId: "measurement-uncertainty-lab",
    predictPrompt: "A trolley travels 0.80 m in 2.0 s. Before seeing the lab's working, which unit must its average speed have?",
    aidTypes: [
      "simulation",
      "misconception-audit",
      "transfer-problem",
    ...
    misconceptions: [
      ...
      "Uncertainty as separate from units",
    ],
    ...
    firstPrinciples: "A physical quantity is something about the world that can be measured. The measurement is incomplete unless it gives a numerical value, a unit, and, in a real practical setting, an uncertainty. Writing 5 is just a number; writing 5 m says the quantity is a length and the metre is the comparison standard. Writing 5.0 ± 0.1 m says how precisely that length was measured.",
    keyDefinitions: [
