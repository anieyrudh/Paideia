...
import GeneratedSim0PhysicalQuantitiesAndUnitsDimensionalConsistencyChecker from "@paideia/a-level-physics-sims/physical-quantities";
...
export const knowledgeGraph = {
  ...
  { from: "a-level/physics/physical-quantities-and-units", to: "a-level/physics/kinematics-in-one-dimension", kind: "downstream" },
...
export const containers = [
  {
    ...
    predictPrompt: "A learner proposes three equations: v = s/t, F = ma, and s = vt + 1/2 at. Before opening the checker, which one do you think the units will reject?",
    aidTypes: [
      "simulation",
      "misconception-audit",
      "transfer-problem",
    ...
    problemSolvingSteps: [
      ...
      "Compare every addable or equated term",
      "Reject dimension mismatches before substituting numbers",
