...
import GeneratedSim0PhysicalQuantitiesAndUnitsUnitClassificationLab from "@paideia/a-level-physics-sims/physical-quantities-lab";
...
export const containers = [
  {
    ...
    predictPrompt: "A lab note says acceleration = 9.8 m s^-2. Before checking the card wall, which statement is safest?",
    aidTypes: [
      "simulation",
      "misconception-audit",
      "transfer-problem",
    ...
    problemSolvingSteps: [
      ...
      "Classify the record as base, derived, unit only, or number only",
