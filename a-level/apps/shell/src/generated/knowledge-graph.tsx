...
import GeneratedSim0PhysicalQuantitiesAndUnitsQuantityDependencyMap from "@paideia/a-level-physics-sims/quantity-map";
...
export const containers = [
  {
    ...
    module: "Foundations of Physics",
    title: "Physical Quantities and Units",
    summary: "Separate physical quantities from units, map base-to-derived dependencies, and use dimensions to reject impossible equations.",
    syllabusRef: "9478 / Section I / 1(a)-1(g)",
    status: "reviewed",
    packageId: "physical-quantities-and-units",
    simId: "quantity-dependency-map",
    predictPrompt: "Before opening the map, which equation keeps the units of speed consistent with distance and time?",
    aidTypes: [
      "simulation",
      "misconception-audit",
      "transfer-problem",
    ...
    misconceptions: [
      ...
      "Base and derived quantities are interchangeable",
    ],
    ...
    problemSolvingSteps: [
      ...
      "Classify as base or derived",
      "Map dependencies to base quantities",
    ...
    sims: [
      {
        id: "quantity-dependency-map",
        title: "Quantity Dependency Map",
        interactionType: "force-directed-graph",
        component: GeneratedSim0PhysicalQuantitiesAndUnitsQuantityDependencyMap,
      },
    ],
  },
  {
