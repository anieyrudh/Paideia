...
import GeneratedSim0PhysicalQuantitiesAndUnitsQuantityMapLab from "@paideia/a-level-physics-sims/quantity-map";
...
export const containers = [
  {
    ...
    module: "Foundations of Physics",
    title: "Physical Quantities and Units",
    summary: "Use a dependency map of SI base and derived quantities to separate quantities, units, scalar/vector nature, and dimensionally valid equations.",
    syllabusRef: "9478 / Section I / 1(a)-1(g)",
    status: "reviewed",
    packageId: "physical-quantities-and-units",
    simId: "quantity-map-lab",
    predictPrompt: "Before opening the map: force is measured in newtons. Which base dimensions must a correct expression for force contain?",
    aidTypes: [
      "simulation",
      "misconception-audit",
      "transfer-problem",
    ...
    misconceptions: [
      ...
      "Equation shape overrides dimensions",
    ],
    ...
    sims: [
      {
        id: "quantity-map-lab",
        title: "Quantity Map Lab",
        interactionType: "force-directed-graph",
        component: GeneratedSim0PhysicalQuantitiesAndUnitsQuantityMapLab,
      },
    ],
  },
  {
