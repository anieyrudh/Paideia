...
import GeneratedSim0PhysicalQuantitiesAndUnitsUnitClassificationLab from "@paideia/a-level-physics-sims/physical-quantities";
...
export const containers = [
  {
    ...
    simId: "unit-classification-lab",
    predictPrompt: "A lab note says an acceleration is 9.8 m s^-1. Before opening the lab, what kind of mistake do you expect to find?",
    aidTypes: [
      "simulation",
      "misconception-audit",
      "transfer-problem",
    ...
    problemSolvingSteps: [
      ...
      "Classify base or derived",
      "Reduce to base dimensions",
      "Check dimensions before operating",
      "Explain why the unit allows or blocks the equation",
    ...
    sims: [
      {
        ...
        component: GeneratedSim0PhysicalQuantitiesAndUnitsUnitClassificationLab,
      },
    ],
  },
  {
