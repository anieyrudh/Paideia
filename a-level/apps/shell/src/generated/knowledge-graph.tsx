...
export const knowledgeGraph = {
  ...
  { from: "a-level/physics/physical-quantities-and-units", to: "a-level/physics/dimensional-analysis", kind: "sibling" },
...
export const containers = [
  {
    ...
    predictPrompt: "A student proposes s = ut + 1/2at for motion. Before the detector opens, predict whether the equation can be valid just by checking units.",
    aidTypes: [
      "simulation",
      "misconception-audit",
      "transfer-problem",
    ...
    problemSolvingSteps: [
      ...
      "Classify base/derived and scalar/vector status",
      "Expand derived units if needed",
      "Compare added or equated dimensions",
      "Reject dimension mismatches as impossible",
      "Use physics reasoning after dimensions pass",
    ],
    prerequisites: [],
    downstream: [
      "Scalars and Vectors",
    ...
    sims: [
      {
        ...
        interactionType: "consistency-checker",
