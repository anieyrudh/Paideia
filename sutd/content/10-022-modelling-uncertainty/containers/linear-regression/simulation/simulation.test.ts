...
test.describe("Linear Regression", () => {
  ...
  test("prediction-checkpoint keeps regression evidence visible while saving reflection", async ({ page }) => {
    {
      const setupButton = page.getByRole("button", { name: "Set regression data" });
