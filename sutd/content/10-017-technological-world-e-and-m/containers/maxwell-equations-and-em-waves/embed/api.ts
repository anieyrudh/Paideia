...
export const ContainerEmbedStateSchema = z.object({ predictionCommitted: z.boolean() }).strict();
export const ContainerEmbedThemeSchema = z
  .object({ colorScheme: z.enum(["light", "dark"]), accentColor: z.string().optional() })
  .strict();
