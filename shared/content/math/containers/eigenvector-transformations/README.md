...
- Transfer problems:
  - `problem-solving/modal-axis-decoupling.md` - thermal mode interpretation

## Citations and provenance

- Source records in `container.yaml`: 2
- Human-readable source file: `sources.md`
- Original container path: `shared/content/math/containers/eigenvector-transformations`
